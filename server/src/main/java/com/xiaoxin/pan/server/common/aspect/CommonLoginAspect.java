package com.xiaoxin.pan.server.common.aspect;
...
public class CommonLoginAspect {
     ...
     * 切点表达式
     */
    private final static String POINT_CUT = "execution(* com.xiaoxin.pan.server.modules.*.controller..*(..))";
     ...
     * 校验是否需要登录信息
     */
    public boolean checkNeedCheckLoginInfo(ProceedingJoinPoint proceedingJoinPoint) {
