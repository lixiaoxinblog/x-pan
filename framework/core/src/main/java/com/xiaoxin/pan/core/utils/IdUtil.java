...
public class IdUtil {
    ...
    public static Long decrypt(String decryptId) {
        if (StringUtils.isNotBlank(decryptId)) {
            ...
            throw new XPanBusinessException("AES128Util.aesDecode fail");
        }
        throw new XPanBusinessException("the decryptId can not be empty");
    }
    ...
    public static List<Long> decryptIdList(String decryptIdStr) {
        ...
        List<String> decryptIdList = Splitter.on(XPanConstants.COMMON_SEPARATOR).splitToList(decryptIdStr);
